...
interface PendaftaranService {
    ...
    suspend fun getPendaftaranByIdPendaftaran(@Query("id_pendaftaran") idPendaftaran: Pendaftaran): Pendaftaran
    ...
    suspend fun updatePendaftaran(@Query("id_pendaftaran") idPendaftaran: Pendaftaran, @Body pendaftaran: Pendaftaran)

    @DELETE("deletePendaftaran.php/{id_pendaftaran}")
    suspend fun deletePendaftaran(@Query("id_pendaftaran") pendaftaran: Pendaftaran): Response<Void>
}